...
#include "include/SFML/Window/GlResource.hpp"
...
public:
  ...
  ///
  /// \param mode     Video mode to use (defines the width, height and depth of the rendering area of the
  /// window) \param title    Title of the window \param style    %Window style, a bitwise OR combination of
  /// sf::Style enumerators \param settings Additional settings for the underlying OpenGL context
  ///
  ////////////////////////////////////////////////////////////
