...
// Headers
////////////////////////////////////////////////////////////
#include "include/SFML/Audio/Export.hpp"
#include "include/SFML/Audio/SoundSource.hpp"
#include "include/SFML/System/Mutex.hpp"
#include "include/SFML/System/Thread.hpp"
...
private:
  ...
  Int64 m_bufferSeeks[BufferCount]; ///< If buffer is an "end buffer", holds next seek position, else NoLoop.
