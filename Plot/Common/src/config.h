...
namespace Config
{
  ...
  static constexpr unsigned int WINDOW_WIDTH{1028};
  static constexpr unsigned int WINDOW_HEIGHT{480};
  static constexpr unsigned int AXIS_FONT_SIZE{14};

  static constexpr float MARKER_LENGTH{10.0};
  static constexpr float AXIS_LINE_THICKNESS{2.0};

  static const sf::Vector2f REFERENCE_POINT{WINDOW_WIDTH * 0.05, WINDOW_HEIGHT * 0.9};
  static const sf::Vector2f X_AXIS_MARKER_REFERENCE_POINT{REFERENCE_POINT.x - MARKER_LENGTH / 2, REFERENCE_POINT.y + AXIS_FONT_SIZE / 2};
  static const sf::Vector2f Y_AXIS_MARKER_REFERENCE_POINT{REFERENCE_POINT.x - MARKER_LENGTH * 3, REFERENCE_POINT.y - AXIS_FONT_SIZE / 2};

  static const sf::Vector2f MARKER_DIMENSION{MARKER_LENGTH, AXIS_LINE_THICKNESS};
  static const sf::Vector2f X_AXIS_DIMENSION{WINDOW_WIDTH - 180.0, AXIS_LINE_THICKNESS};
  static const sf::Vector2f Y_AXIS_DIMENSION{AXIS_LINE_THICKNESS, WINDOW_HEIGHT - 80.0};
  ...
  namespace Legend
  {
    ...
    static constexpr float FONT_PIXEL_SCALE{1.0};
    ...
    static const sf::Vector2f FRAME_POSITION_ORIGIN{Config::WINDOW_WIDTH * 0.70, Config::WINDOW_HEIGHT * 0.1};
