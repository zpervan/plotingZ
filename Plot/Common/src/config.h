...
namespace Config {
    ...
    static const sf::Vector2f MARKER_DIMENSION{MARKER_LENGTH, LINE_THICKNESS};
    static const sf::Vector2f X_AXIS_DIMENSION{WINDOW_WIDTH - EDGE_OFFSET, LINE_THICKNESS};
    static const sf::Vector2f Y_AXIS_DIMENSION{LINE_THICKNESS, WINDOW_HEIGHT - EDGE_OFFSET};
    static sf::Font FONT{};
}
