...
TEST(PlottingDataBuilderTest, GivenValidData_WhenCreatingPlottingDataMock_ThenPlottingDataMockFilledWithCorrectData) {
  PlottingDataBuilder plotting_data_builder;
  PlottingData plotting_data = std::move(plotting_data_builder
											 .SetMaxXValue(10.0)
											 .SetMaxYValue(20.0)
  ...
  ASSERT_EQ(plotting_data.GetInputDataValuesCollection().size(), expected_mock_input_data_value_collection_size);
