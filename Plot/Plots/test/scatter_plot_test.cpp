...
TEST_F(ScatterPlotTestFixture, DISABLED_GivenValidInputData_WhenCreatingScatterPlot_ThenPointDataPositionsAreCorrect)
{
    const std::size_t expected_point_data_collection_size{5};
    const std::array<sf::Vector2f, 5> expected_point_data_position{
        {{63.0, 429.5}, {623.0, 329.5}, {483.0, 229.5}, {343.0, 129.5}, {203.0, 29.5}}};
