...
INSTANTIATE_TEST_SUITE_P(NormalizeValueParametrizedDeathTest,
                         NormalizeValueDeathTestFixture,
...
INSTANTIATE_TEST_SUITE_P(NormalizeValueParametrizedTest,
                         NormalizeValueTestFixture,
...
class ConvertNormalizedPointToAxisScreenSpaceDeathTestFixture : public ::testing::TestWithParam<sf::Vector2f> {
};
...
INSTANTIATE_TEST_SUITE_P(ConvertNormalizedPointToAxisScreenSpaceParametrizedDeathTest,
                         ...
                         testing::Values(sf::Vector2{-0.0001, 0.0001},
                                         sf::Vector2{0.0001, -0.0001},
                                         sf::Vector2{-0.0001, -0.0001},
                                         sf::Vector2{1.0001, 1.0},
                                         sf::Vector2{1.0, 1.0001},
                                         sf::Vector2{1.0001, 1.0001}));
...
INSTANTIATE_TEST_SUITE_P(ConvertNormalizedPointToAxisScreenSpaceParametrizedTest,
