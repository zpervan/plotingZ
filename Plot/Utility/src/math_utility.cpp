...
float MathUtility::CalculateAngleBetweenTwo2DPoints(const sf::Vector2f &first_point,
                                                    const sf::Vector2f &second_point) {
...
float MathUtility::CalculateDistanceBetweenTwo2DPoints(const sf::Vector2f &first_point,
                                                       const sf::Vector2f &second_point) {
  const auto &[delta_x, delta_y] = CalculateDeltas(first_point, second_point);
...
inline std::pair<float, float> CalculateDeltas(const sf::Vector2f &first_point,
                                               const sf::Vector2f &second_point) {
